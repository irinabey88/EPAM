...
namespace BLL.Interface.Entities
{
    ...
    public sealed class PlatinumAccount : Account
    {
        ...
        public PlatinumAccount(string firstName, string lastName, AccountType typeAccount, decimal amount, int bonus) : base(firstName, lastName, typeAccount, amount, bonus)
        {
        }
