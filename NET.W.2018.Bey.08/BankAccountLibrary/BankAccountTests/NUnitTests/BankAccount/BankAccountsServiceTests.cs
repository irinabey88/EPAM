...
namespace BankAccountTests.NUnitTests.BankAccount
{
    using System;
    using System.IO;
    using System.Linq;
    ...
    using DataAccess.Exception.User;
    ...
    public class BankAccountsServiceTests
    {
        ...
        private IBankAccountService<Models.Accounts.Base.BankAccount> _bankAccountService;
